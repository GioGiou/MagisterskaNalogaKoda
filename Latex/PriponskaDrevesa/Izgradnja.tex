...
Ta metoda v vsakem koraku s sprehodom po drevesu podaljša vse pripone za en znak ter doda novo pripono. Metoda v $i$-tem koraku gradnje v dosedaj zgrajeno drevo, ki je bilo zgrajeno za podniz $T[1:i-1]$, doda znak $T[i]$ ter tako zgradi drevo za podniz $T[1:i]$. 
    ...
    \caption{Izboljšana naivna metoda gradnje priponskega drevesa}\label{alg:IzboljsanaNaivna}
    {
        ...
        \Za{$i = 1, \ldots, n$}{
            ...
            \Za{$j = 1, \ldots, i-1$}{
                ...
                \lCe{$\List{v}$}{
                    {Uporabi način podalševanja pripon \ref{enum:dodajanje1}  (strani \pageref{par:naciniDodajanja})} 
                }
                \Sicer{
                    ...
                    \SicerCe{$|\Niz{u}[i-j+1]\ne T[i] $}{
                        ...
                        {Uporabi način podalševanja pripon \ref{enum:dodajanje2} (strani \pageref{par:naciniDodajanja})} 
...
Iz Algoritma \ref{alg:IzboljsanaNaivna} je razvidno, da se metoda v $i$-tem koraku sprehodi po seznamu vozlišč velikosti $O(i)$ ter tako podaljša $i$ pripon. Vhodna beseda je dolga $n$ znakvo, zato je čas gradnje z izboljšano naivno metodo $O(n^2)$. Iz tega sledi izrek:
