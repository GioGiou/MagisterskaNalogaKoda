...
\begin{defi}\label{def:priposkoDrevo}
    ...
    \begin{enumerate}
        ...
        \item podniz, ki je pridobljen s stikom podnizov na povezavah na poti od korena do lista $l_i$, predstavlja pripono $T[i,n]$ za vsak $i$, kjer je $1 \le i\le n$.        
    \end{enumerate}
\end{defi}
