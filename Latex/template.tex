...
\vspace{4cm}
\begin{center}
\large {Koper, 2025} %spremeni mesec oddaje
...
Število listov: 87 \hspace{2cm} Število slik: 22 \hspace{2.6cm} Število tabel: 4\hspace{2cm} \\ %\vspace{0.5cm}\\
...
Number of pages: 87\hspace{1.6cm} Number of figures: 22\hspace{2.2cm} Number of tables: 4\\ %\hspace{2cm}  %\vspace{0.5cm}\\
