...
Suban J. Operacije nad kompaktnimi priponskimi drevesi.\\ %Spremeni naslov dela
\noindent Univerza na Primorskem, Fakulteta za matematiko, naravoslovje in informacijske tehnologije, 2024}]{{\fontsize{9.3}{12}\selectfont
Suban J. Operacije nad kompaktnimi priponskimi drevesi.\\ %Spremeni naslov dela
...
\normalsize
(Compressed Suffix Tree)\\ %Spremeni naslov dela v angleščini
\end{center}
...
\vspace{4cm}
\begin{center}
\large {Koper, mesec 2024} %spremeni mesec oddaje
...
Number of pages: \hspace{1.6cm} Number of figures: \hspace{2.2cm} Number of tables:\\ %\hspace{2cm}  %\vspace{0.5cm}\\
Number of appendices: \hspace{0.6cm} Number of appendix pages: \hspace{0.8cm} \\
Number of references:\\ %\vspace{0.5cm}\\
...
\chapter{KOMPAKTNA PREDSTAVITEV}\label{sec:Kompaktna}
\thispagestyle{fancy} 
