...
\vspace{4cm}
\begin{center}
\large {Koper, julij 2025} %spremeni mesec oddaje
...
Število listov: 86 \hspace{2cm} Število slik: 22 \hspace{2.6cm} Število tabel: 4\hspace{2cm} \\ %\vspace{0.5cm}\\
%Število prilog: \hspace{1.9cm} Število strani prilog: \hspace{1cm} \\
Število referenc: 31\\ %\vspace{0.5cm}\\
Mentor: prof. dr. Andrej Brodnik \\
Somentor: izr. prof. dr. Rok Požar\vspace{0.5cm}\\
UDK: \\
Ključne besede:\\ %\vspace{0.5cm}\\
Priponska drevesa, Priponska polja, Kompaktna priponska drevesa, Kompaktne podatkovne strukture\\ %\vspace{0.5cm}\\ %Spremeni ključne besede
Izvleček: \\
Magistrska naloga obravnava problem iskanja vzorcev v daljših besedah z uporabo podatkovnih struktur, kot so priponsko drevo, priponsko polje in kompaktno priponsko drevo. Namen naloge je preučiti vpliv kompaktne predstavitve na izgradnjo in uporabo priponskih dreves, zato je bila storjena empirična primerjava teh struktur. Primerjav je bila storjena za zaporedje genov ter za besedilo v naravnem jeziku. Pri tem se vidijo praktične prednosti kompaktnosti, saj se zmanjša učinkovitosti priponskega drevesa, ko presega velikost delovnega pomnilnika in zato potrebuje Swap razdelek na disku. Te težave nimata priponsko polje in kompaktno priponsko drevo za testirane velikosti besed.
...
\chapter{EMPIRIČNA EVALVACIJA OPERACIJI NAD PRIPOSKIMI DREVESI}\label{sec:OPeracije}
\thispagestyle{fancy} 
