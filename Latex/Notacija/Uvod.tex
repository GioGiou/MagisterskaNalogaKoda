...
Skozi magistrsko nalogo bo $\Sigma$ predstavljala abecedo. Abeceda je množica znakov $\Sigma=\{\sigma_1,\dots,\sigma_a\}$. Znake v $\Sigma$ lahko uredimo v zaporedje ter definiramo, da je $\sigma_i$ manjši od $\sigma_j$, ki je različen od $\sigma_i$, natako tedaj ko se zank $\sigma_i$ pojavi pred znakom $\sigma_j$ v zaporedju. Sicer je $\sigma_i$ večji od $\sigma_j$.
